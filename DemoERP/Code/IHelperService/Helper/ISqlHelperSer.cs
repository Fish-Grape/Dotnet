...
namespace IHelperService.Helper
{
    public interface ISqlHelperSer
    {
        string ExecuteToString(string storedProcName, IDataParameter[] parameters, ConnctionType t = ConnctionType.ReadWrite);
        string ExecuteToString(string storedProcName, ConnctionType t = ConnctionType.ReadWrite);
